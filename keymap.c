...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_esnahn( \
      ...
      KC_LSFT,               KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  RSFT_T(KC_SLSH),  KC_RSFT, KC_RSFT, \
      KC_LCTL,      KC_LGUI, KC_LALT,          KC_SPC, LT(10, KC_SPC),                      KC_LNG2, KC_DEL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT \
  ),    
  ...
  [10] = LAYOUT_esnahn( \
      ...
      _______,              _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_QUES,          _______, _______, \
      _______,     _______, _______,          _______,          _______,                   KC_CAPS, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // 3: left space as lang1
  [3] = LAYOUT_kbd75_esnahn(
  ...
  // 9: normal Layer; should be higher than other toggle layers
  [9] = LAYOUT_kbd75_esnahn(
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
  ...
  [11] = LAYOUT_kbd75_esnahn(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,  _______,  _______,            _______,  _______,
    _______,  _______,  _______,                      TG(3),    TG(9),    _______,                      _______,  _______,            _______,  _______,  _______
  ),
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    rgblight_set_layer_state(0, IS_LAYER_ON_STATE(state, 9));

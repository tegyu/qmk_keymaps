...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [10] = LAYOUT_esnahn( \
      ...
      _______,     KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______, _______, _______, _______, _______, _______, _______, MO(12),           \
      ...
      _______,     _______, _______,          KC_LANG2,         _______,                   _______, _______, _______, KC_HOME, KC_PGDN, KC_END   \
  ),
  // 11: 10 + Media Layer
  [11] = LAYOUT_esnahn( \
      _______,     KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PSCR,          \
  ...
  // 12: Spacebar Toggle Layer
  [12] = LAYOUT_esnahn( \
      _______,     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          \
      _______,     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          \
      _______,     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          \
      _______,              _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
      _______,     _______, _______,          TG(1),            _______,                   _______, _______, _______, _______, _______, _______  \
  ),
/*   // 12: Shift Layer
  [12] = LAYOUT_esnahn( \
